...
export function handleSSRError(e, res, notFoundForAll = false) {
  if (typeof e.code === "string" && typeof e.messageError === "string") {
    if (e.code === "ERROR_GONE") return { notFound: true };
    else if (e.code === "ERROR_UNAUTHORIZED") return { redirect: { destination: "/auth/login", permanent: false } };

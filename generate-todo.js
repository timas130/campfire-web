...
let totalRequests = requestList.length, usedRequests = 0;
...
todo += "## Summary\n";
todo += `* ${usedRequests}/${totalRequests} (${(usedRequests / totalRequests * 100)
  .toFixed(1)}%) requests used\n`;
todo += `* Generated at: \`${new Date().toLocaleString()}\`\n\n`;

todo += "## Requests\n";

for (const request of requestList) {
  todo += "* [" + (request.used ? "x" : " ") + "] " + request.name + "\n";
}
